...
<div class="container-fluid dashboard">
    ...
    <h1>[+site_name+]</h1>
     ...
     <div class="container col-sm-12" style="display:[+config_display+]">
      ...
      <!--widget -->
      <div class="col-sm-12" style="display:[+logobox_display+]">
...
<div class="row">
      ...
      <div class="col-lg-6" style="display:[+userinfo_display+]">
        <div class="widget-wrapper">
          <div class="widget-title sectionHeader">
     ...
     <div class="col-lg-6" style="display:[+messageinfo_display+]">
        <div class="widget-wrapper">
          <div class="widget-title sectionHeader">
...
<div class="row">
      ...
      <div class="col-lg-6" style="display:[+modxnews_display+]">
        <div class="widget-wrapper">
          <div class="widget-title sectionHeader">
      ...
      <div class="col-lg-6" style="display:[+modxsecuritynews_display+]">
        <div class="widget-wrapper">
          <div class="widget-title sectionHeader">
...
<div class="row">
      ...
      <div class="col-lg-6" style="display:[+recentinfo_display+]">
        <div class="widget-wrapper">
          <div class="widget-title sectionHeader">
      ...
      <div class="col-lg-6" style="display:[+onlineinfo_display+]">
        <div class="widget-wrapper">
